...
This article will demonstrate a random assortment of content, including
some of which is more advanced.
...
![](3_go_further_files/figure-html/unnamed-chunk-2-1.png)
...
![](3_go_further_files/figure-html/unnamed-chunk-3-1.png)
...
![](3_go_further_files/figure-html/unnamed-chunk-4-1.png)

### Reorder and/or reverse categorical variables

ggblanket requires unquoted variables only for `x`, `y`, `col`, `facet`,
`facet2` and `alpha`. You can often manipulate the data prior to
plotting to achieve what you want (e.g. using
...
![](3_go_further_files/figure-html/unnamed-chunk-5-1.png)

### Drop unused categorical variable values

ggblanket keeps unused factor levels in the plot. If users wish to drop
unused levels they should likewise do it in the data prior to plotting
using
...
![](3_go_further_files/figure-html/unnamed-chunk-6-1.png)

### Transform scales to `"log"` etc

Transform objects
(e.g. [`transform_log()`](https://scales.r-lib.org/reference/transform_log.html)
or character strings of these can be used to transform scales -
...
![](3_go_further_files/figure-html/unnamed-chunk-7-1.png)

### Correct the default orientation

The `gg_*` function guesses the `*_orientation` of the plot to determine
how to make continuous axes and what side-effects to have on the
provided theme. If it guesses incorrectly, use either the
`x_orientation` or `y_orientation` argument.
...
![](3_go_further_files/figure-html/unnamed-chunk-8-1.png)
...
![](3_go_further_files/figure-html/unnamed-chunk-9-1.png)

### Change the `*_position` of positional axes

Positional axes can be changed using `*_position`.

Note that for `x_position = "top"`, a caption must be added or modified
to make this work nicely with a `*_mode_*` theme.
...
![](3_go_further_files/figure-html/unnamed-chunk-10-1.png)
...
`*_expand_limits` and `coord = coord_cartesian(xlim = ..., ylim = ...)`
arguments etc.
...
![](3_go_further_files/figure-html/unnamed-chunk-11-1.png)
...
![](3_go_further_files/figure-html/unnamed-chunk-12-1.png)
...
![](3_go_further_files/figure-html/unnamed-chunk-13-1.png)

### Use delayed evaluation

The `mapping` argument can be used for delayed evaluation with the
...
![](3_go_further_files/figure-html/unnamed-chunk-14-1.png)
...
![](3_go_further_files/figure-html/unnamed-chunk-15-1.png)
...
![](3_go_further_files/figure-html/unnamed-chunk-16-1.png)
...
![](3_go_further_files/figure-html/unnamed-chunk-17-1.png)

### Specifying panel sizes

For non-faceted plots, use
...
![](3_go_further_files/figure-html/unnamed-chunk-18-1.png)

For faceted plots, use
