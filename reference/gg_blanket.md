...
Create a blanket ggplot with a wrapper around
[`ggplot2::ggplot()`](https://ggplot2.tidyverse.org/reference/ggplot.html) +
[`layer()`](https://ggplot2.tidyverse.org/reference/layer.html) with
[geom_blank()](https://ggplot2.tidyverse.org/reference/geom_blank.html)
defaults. This function underlies all other `gg_*` functions. It
contains a `geom` argument for maximum flexibility.
...
- geom:
  ...
  A geometric object to display the data. A snakecase character string
  of a ggproto Geom subclass object minus the Geom prefix (e.g.
  `"point"`).
