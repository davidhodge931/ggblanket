...
#' @param col_pal A 5 colour vector for use with the `light_mode_*` themes to colour the (1) plot background etc (2) panel background etc, (3) gridlines, (4) axisline/ticks.(5) and text.  Defaults to pal_light_mode.
...
light_mode_rt <- function (
  ...
  ggplot2::theme(
    ...
    legend.key = ggplot2::element_rect(colour = col_pal[1], fill = col_pal[1]), #legend.key = ggplot2::element_rect(colour = col_pal[1], fill = col_pal[1]),
