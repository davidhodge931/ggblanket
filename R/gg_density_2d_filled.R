...
#'
#' @description Create a density_2d_filled ggplot with a wrapper around [ggplot()][ggplot2::ggplot()] + [layer()][ggplot2::layer()] with [geom_density_2d_filled()][ggplot2::geom_density_2d_filled()] defaults.
#'
