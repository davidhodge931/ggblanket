#' @title Jitter ggplot
#'
#' @description Create a jitter ggplot with a wrapper around the ggplot2::geom_jitter function.
...
#' @param ... Other arguments passed to the ggplot2::geom_jitter function.
