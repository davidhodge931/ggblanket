#' Quantile ggplot
#'
#' @description Create an quantile ggplot with a wrapper around [ggplot()][ggplot2::ggplot()] + [layer()][ggplot2::layer()] with [geom_quantile()][ggplot2::geom_quantile()] defaults for the geom, stat and position.
#'
...
gg_quantile <- function(
  ...
  text = NULL,
  sample = NULL,
  mapping = NULL, bordered = NULL, bordered_colour_by = NULL, bordered_fill_by = NULL,  bordered_linewidth = NULL,
  x_breaks = NULL,
  x_breaks_n = NULL,
  x_expand = NULL,
