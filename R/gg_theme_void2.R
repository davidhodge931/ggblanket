#' @title Void theme for a ggplot
#'
#' @description Void theme for a ggplot visualisation. Element prefixes to modify are: text_, title_, subtitle_, caption_, background_pal_, and gridlines_.
...
#' @param caption_pal The colour of the caption. Defaults to the text_pal with an alpha of 0.55.
...
gg_theme_void <- function(
    ...
    caption_pal = scales::alpha(text_pal, 0.55),
    caption_face = "plain",
