#' Col ggplot
#'
#' @description Create a col ggplot with a wrapper around [ggplot()][ggplot2::ggplot()] + [layer()][ggplot2::layer()] with [geom_col()][ggplot2::geom_col()] defaults for the geom, stat and position.
#'
...
gg_col <- function(
  ...
  gg_blanket(
    ...
    bordered = bordered, bordered_colour_by = bordered_colour_by, bordered_fill_by = bordered_fill_by,  col_breaks = col_breaks, col_breaks_n = col_breaks_n,
    col_drop = col_drop,
