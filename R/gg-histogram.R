#' Histogram ggplot
#'
#' @description Create a histogram ggplot with a wrapper around [ggplot()][ggplot2::ggplot()] + [annotate()][ggplot2::annotate()] with [geom_histogram()][ggplot2::geom_histogram()] defaults for the geom, stat and position.
#'
