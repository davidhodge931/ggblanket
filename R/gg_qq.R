#' Qq ggplot
#'
#' @description Create a qq ggplot with a wrapper around [ggplot()][ggplot2::ggplot()] + [layer()][ggplot2::layer()] with [geom_qq()][ggplot2::geom_qq()] defaults for the geom, stat and position.
#'
