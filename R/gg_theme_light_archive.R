...
#' #'   )
#' #'
#' gg_theme_light2 <- function(text_size = 10,
#'                             text_family = "",
...
#'   if (is.null(ticks_pal))
#'     ticks_pal <- line_pal
#'   if (is.null(background_pal_key))
#'     background_pal_key <- background_pal_plot
#'   if (is.null(ticks_linewidth))
...
#'       colour = other_text_pal,
#'       face = other_text_face
#'     ),
...
#'       vjust = 0.5,
#'       margin = ggplot2::margin(b = other_text_size * 0.5),
#'       angle = 0
#'     ),
#'     strip.text.y = ggplot2::element_text(
#'       vjust = 0.5,
#'       margin = ggplot2::margin(l = other_text_size * 0.75),
#'       angle = 270
#'     ),
#'
