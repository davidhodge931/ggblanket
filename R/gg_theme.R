...
gg_theme <- function(
  ...
  theme <- ggplot2::theme(
    ...
    strip.text.x = ggplot2::element_text(family = text_family, size = text_size, colour = text_pal, face = text_face, hjust = 0.5, vjust = text_size * 0.33, margin = ggplot2::margin(t = text_size * 0.5)),
