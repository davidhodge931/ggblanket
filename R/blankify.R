...
geom_defaults_light <- function(col_pal = blue) {
  ...
  rlang::list2({
    ...
    ggplot2::update_geom_defaults("boxplot", ggplot2::aes(colour = col_pal, fill = col_pal, alpha = 0.9 * 0.5, linewidth = 0.66))
    ...
    ggplot2::update_geom_defaults("crossbar", ggplot2::aes(colour = col_pal, fill = col_pal, alpha = 0.9 * 0.5, linewidth = 0.66))
    ggplot2::update_geom_defaults("density", ggplot2::aes(colour = col_pal, fill = col_pal, alpha = 0.9 * 0.5, linewidth = 0.66))
    ...
    ggplot2::update_geom_defaults("ribbon", ggplot2::aes(colour = col_pal, fill = col_pal, alpha = 0.9 * 0.5, linewidth = 0.66))
    ...
    ggplot2::update_geom_defaults("smooth", ggplot2::aes(colour = col_pal, fill = col_pal, alpha = 0.9 * 0.5, linewidth = 0.66))
