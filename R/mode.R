...
#' @param col_pal A 6 colour vector for the 1) text 2) caption 3) axis line 4) panel background 5) plot background 6) gridlines
#'
#' @keywords internal
mode_rt <- function (
    base_size = 11,
  ...
  ggplot2::theme(
    line = ggplot2::element_line(colour = col_pal[3], linewidth = base_size/33, linetype = 1, lineend = "square"),
    rect = ggplot2::element_rect(fill = col_pal[5], colour = col_pal[5], linewidth = base_size/33, linetype = 1),
    text = ggplot2::element_text(family = base_family, face = "plain", colour = col_pal[1], size = base_size,
    ...
    legend.key = ggplot2::element_rect(colour = col_pal[5], fill = col_pal[5]),
    ...
    panel.background = ggplot2::element_rect(fill = col_pal[4], colour = col_pal[4]),
    panel.border = ggplot2::element_blank(),
    panel.grid = NULL,
    panel.grid.major = ggplot2::element_line(colour = col_pal[6], linewidth = ggplot2::rel(0.5)),
    ...
    plot.caption = ggplot2::element_text(colour = col_pal[2], size = ggplot2::rel(0.9), hjust = 0, margin = ggplot2::margin(t = base_size * 0.5, r = 0, b = base_size * 0.5, l = 0)),
...
mode_i <- function (
  ...
  ggplot2::theme(
    ...
    legend.background = ggplot2::element_rect(colour = col_pal[3], fill = col_pal[3]),
    axis.text.x = ggplot2::element_text(vjust = 1, margin = ggplot2::margin(t = base_size * 0.2, r = 0, b = base_size * 1, l = 0)),
    axis.title.x = ggplot2::element_text(margin = ggplot2::margin(t = base_size * -0.33, r = 0, b = base_size * 0.75, l = 0)),
    axis.title.x.top = ggplot2::element_text(margin = ggplot2::margin(t = base_size * -1, r = 0, b = base_size * 1, l = 0)),
    axis.text.x.top = ggplot2::element_text(vjust = 0, margin = ggplot2::margin(t = base_size * -0.5, r = 0, b = base_size * 0.2, l = 0)),
