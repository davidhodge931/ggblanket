#' Segment ggplot
#'
#' @description Create a segment ggplot with a wrapper around [ggplot()][ggplot2::ggplot()] + [annotate()][ggplot2::annotate()] with [geom_segment()][ggplot2::geom_segment()] defaults for the geom, stat and position.
#'
