...
gg_boxplot <- function(data = NULL,
  ...
  if (!rlang::quo_is_null(col)) rlang::inform(c("i" = "Note in {ggboxplotet}, the {ggplot2} fill aesthetic inherits from col"))
  # rlang::inform(c("i" = "Note {ggboxplotet} gg_bar uses the {ggplot2} geom_boxplot function"))
  # if (is.null(position)) rlang::inform(c("i" = "Note {ggboxplotet} gg_bar uses a default of 'dodge2', where {ggplot2} uses a default of 'stack'"))
