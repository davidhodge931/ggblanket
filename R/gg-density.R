#' Density ggplot
#'
#' @description Create a density ggplot with a wrapper around [ggplot()][ggplot2::ggplot()] + [annotate()][ggplot2::annotate()] with [geom_density()][ggplot2::geom_density()] defaults for the geom, stat and position.
#'
