#' #' @title Point ggplot
#' #'
#' #' @description Create a Point ggplot with a wrapper around ggplot2::layer() and ggplot2::GeomPoint.
...
#' #' @param na_col Colour to use for NA values. A character vector of a hex code (or name).
