...
gg_point2 <- function(
  ...
  if (col_scale) {
    ...
    if (rlang::is_null(col_legend_place)) {
      if (col_numeric | col_date | col_datetime | col_time | col_null) col_legend_place <- "right"
    ...
    ########################
    ##if it is a numeric or ordered colour/fill variable, and if so use viridis
    ##if it is a categorical or ordered colour variable, use scale_*_manual
    ##if it is a numeric colour variable, use scale_*_gradientn
    ##if it is a date/time colour variable, use scale_*_gradientn with trans argument
    ########################
