...
#' @examples
#' library(ggplot2)
#' gg_point2(economics, x = date, y = unemploy)
#' gg_point2(economics, x = date, y = unemploy, linetype = 2)
#' gg_point2(economics_long, x = date, y = value01, col = variable)
#' gg_point2(economics, x = unemploy, y = date, orientation = "y")
#'
gg_point2 <- function(
    data = NULL,
    x = NULL,
