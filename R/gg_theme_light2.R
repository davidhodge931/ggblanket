...
gg_theme_light2 <- function (
  ...
  theme(line = element_line(colour = base_pal, linewidth = 10/33, linetype = 1, lineend = "square"),
        ...
        legend.title = element_text(hjust = 0, margin = margin(t = 5)),
        ...
        plot.caption = element_text(size = rel(0.9), colour = scales::alpha(base_pal, 0.33), hjust = 0, vjust = 1, margin = margin(t = base_size)),
        plot.caption.position = "plot",
        plot.tag = element_text(size = rel(1.2), hjust = 0, vjust = 0.5),
        plot.tag.position = "topleft",
        plot.margin = margin(t = base_size * 0.75, r = base_size * 1.5, b = base_size * 0.75, l = base_size * 0.75),
        complete = TRUE
  )
}
