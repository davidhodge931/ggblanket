...
#' @param title_vjust The vertical adjustment of the title. Defaults to 1.
...
gg_theme_light <- function (
    ...
    title_vjust = 1,
    title_margin = ggplot2::margin(t = base_size * -0.5, b = base_size * 1.5),
    subtitle_family = NULL,
    subtitle_face = NULL,
    subtitle_pal = NULL,
    subtitle_size = NULL,
    subtitle_vjust = 1,
    subtitle_margin = ggplot2::margin(t = base_size * -1, b = base_size * 1.5),
    caption_family = NULL,
    caption_face = NULL,
    caption_alpha = 0.33,
