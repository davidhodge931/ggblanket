#' Quantile ggplot
#'
#' @description Create an quantile ggplot with a wrapper around [ggplot()][ggplot2::ggplot()] + [annotate()][ggplot2::annotate()] with [geom_quantile()][ggplot2::geom_quantile()] defaults for the geom, stat and position.
#'
