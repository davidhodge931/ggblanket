...
#'
#' @description Update the "text" geom defaults.
#'
#' @param colour A hex code.
#' @param fill A hex code.
#' @param size A size in mm. Use `pt_to_mm` to convert.
#' @param family A family.
#' @param ... Additional arguments passed to element_geom().
#'
#' @noRd
#'
#' @examples
#' weave_geom_text(size = 4.233333)
#' weave_geom_text(size = pt_to_mm(12))
#'
