...
dark_mode_rt <- function (
  ...
  ggplot2::theme(
    ...
    plot.caption = ggplot2::element_text(family = NULL, face = NULL, colour = scales::alpha(darkness[1], 0.33), size = ggplot2::rel(0.9), hjust = 0, vjust = 0.5, margin = ggplot2::margin(t = base_size * 0.5, r = 0, b = base_size * 0.5, l = 0)),
