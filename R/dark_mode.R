...
#' @param base_pal A four colour vector of colours for the text/axis/ticks, plot, panel and gridlines. Defaults to pal_dark_mode.
...
dark_mode <- function (
  ...
  ggplot2::theme(
    ...
    legend.key = ggplot2::element_rect(fill = base_pal[3], colour = base_pal[3]),
