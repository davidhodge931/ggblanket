...
gg_point <- function(data = NULL,
  ...
  # rlang::inform(c("i" = "Note {ggpointet} gg_bar uses the {ggplot2} geom_point function"))
  # if (is.null(position)) rlang::inform(c("i" = "Note {ggpointet} gg_bar uses a default of 'dodge2', where {ggplot2} uses a default of 'stack'"))
