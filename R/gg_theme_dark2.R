...
#' @param title_pal The colour of the title. Defaults to "#d3d3d3".
...
#' @param subtitle_pal The colour of the subtitle. Defaults to "#a8a8a8".
...
#' @param caption_pal The colour of the caption. Defaults to "#777777".
...
#' @param other_text_pal The colour of all text other than the title, subtitle or caption. Defaults to "#d3d3d3".
