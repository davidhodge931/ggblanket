...
#'         colour = title_colour,
#'         hjust = 0,
#'         margin = ggplot2::margin(b = 11 * 2.5)  # Simple bottom margin only, like theme_ipsum
#'       ),
...
#'         hjust = 0,
#'         margin = ggplot2::margin(b = 11 * 2)  # Simple bottom margin only, like theme_ipsum
#'       ),
...
#'       legend.spacing.y = grid::unit(16.5, "pt"),
#'       legend.spacing.x = NULL,
#'       legend.key = ggplot2::element_rect(
#'         colour = legend_key_fill,
#'         fill = legend_key_fill
...
#'       ),
#'
#'       # Adjust plot title spacing for right legend
#'       plot.title = ggplot2::element_text(
#'         margin = ggplot2::margin(b = 5.5)
#'       ),
#'       plot.subtitle = ggplot2::element_text(
#'         margin = ggplot2::margin(b = 16.5)
#'       ),
#'
...
#'         margin = ggplot2::margin(t = 0, r = 0, b = 0, l = 5.5),
#'         angle = -90
#'       ),
#'       axis.text.x = ggplot2::element_text(
#'         vjust = 1,
#'         margin = ggplot2::margin(t = 5.5, r = 0, b = 11, l = 0)
#'       ),
...
#'       ),
#'       legend.title = ggplot2::element_text(
#'         margin = ggplot2::margin(t = 0, r = 0, b = 2.75, l = 0)
#'       ),
#'       legend.byrow = TRUE,
...
#'       ),
#'
#'       # Adjust plot title spacing for top legend
#'       plot.title = ggplot2::element_text(
#'         margin = ggplot2::margin(b = 5.5)
#'       ),
#'       plot.subtitle = ggplot2::element_text(
...
#'       axis.text.x = ggplot2::element_text(
#'         vjust = 0.5,
#'         margin = ggplot2::margin(t = 3.3, r = 0, b = 11, l = 0)
#'       ),
#'       axis.text.x.top = ggplot2::element_text(
#'         vjust = 0.5,
#'         margin = ggplot2::margin(t = 0, r = 0, b = 3.3, l = 0)
#'       )
#'     )
...
#'       ),
#'
#'       # Adjust plot title spacing for bottom legend
#'       plot.title = ggplot2::element_text(
#'         margin = ggplot2::margin(b = 11 * 0.5)
#'       ),
#'       plot.subtitle = ggplot2::element_text(
#'         margin = ggplot2::margin(b = 11 * 1.5)
#'       ),
#'
#'       # Axis settings for bottom legend
#'       axis.title.x = ggplot2::element_text(
#'         margin = ggplot2::margin(t = 0, r = 0, b = 11 * 0.42, l = 0)
#'       ),
#'       axis.title.x.top = ggplot2::element_text(
...
#'       ),
#'       axis.title.y.right = ggplot2::element_text(
#'         margin = ggplot2::margin(t = 0, r = 0, b = 0, l = 11 * 0.5),
#'         angle = -90
#'       ),
#'       axis.text.x = ggplot2::element_text(
#'         vjust = 1,
