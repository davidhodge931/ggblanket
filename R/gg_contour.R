...
#'
#' @description Create a contour ggplot with a wrapper around the ggplot2::geom_contour function.
...
#' @param ... Other arguments passed to the ggplot2::geom_contour function.
