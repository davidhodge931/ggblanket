...
#' @param title_pal The colour of the title. Defaults to 0.08 lighter than the base_pal.
...
gg_theme_dark <- function(
    ...
    title_pal = colorspace::lighten(base_pal, 0.08, method = "absolute"),
    title_face = "bold",
    title_position = "plot",
    title_hjust = 0,
    title_vjust = 1,
  ...
  theme <- ggplot2::theme(
    ...
    axis.line = ggplot2::element_line(colour = "#bbccdd", linewidth = base_size / 33, lineend = "square"),
    axis.ticks = ggplot2::element_line(colour = "#bbccdd", linewidth = base_size / 33),
    axis.ticks.length.x = grid::unit(base_size / 3, "pt"),
    axis.ticks.length.y = grid::unit(base_size / 4, "pt"),
    plot.background = ggplot2::element_rect(colour = "#121b24", fill = "#121b24"),
    plot.margin = ggplot2::margin(t = 15, r = 20, b = 11, l = 10),
    panel.background = ggplot2::element_rect(colour = "#1f2f3e", fill = "#1f2f3e"),
    panel.border = ggplot2::element_blank(),
    panel.grid.major = ggplot2::element_line(colour = "#2C3A48", linewidth = base_size / 100),
    panel.grid.minor = ggplot2::element_blank(),
    panel.spacing = grid::unit(1.25, "lines"),
    legend.background = ggplot2::element_rect(colour = "#121b24", fill = "#121b24"),
    legend.box = NULL,
    legend.box.margin = ggplot2::margin(t = -2.5),
    legend.direction = "vertical",
    legend.justification = "left",
    legend.key = ggplot2::element_rect(colour = "#1f2f3e", fill = "#1f2f3e"),
