#' Lighter theme
#'
#' @description A lighter complete theme. Built for a subtitle of either "" or "<subtitle>\n". Legend place includes many legend elements including position.
#'
  ...
  theme <-
    ...
    ggplot2::theme(
      ...
      axis.text.y = ggplot2::element_text(
        margin = ggplot2::margin(r = 2.75),  # 11 * 0.25
        hjust = 1
      ),
      axis.text.y.right = ggplot2::element_text(
        margin = ggplot2::margin(l = 2.75),  # 11 * 0.25
        hjust = 0
      ),
      legend.spacing = grid::unit(11, "pt"),  # 11 * 1
      legend.spacing.y = grid::unit(16.50, "pt"),  # 11 * 1.5
      ...
      legend.key.spacing.y = grid::unit(3.63, "pt"),  # 11 * 0.33
      legend.frame = NULL,
      ...
      panel.spacing = grid::unit(22, "pt"),  # 11 * 2
      ...
      strip.text = ggplot2::element_text(
        margin = ggplot2::margin(t = 0, r = 0, b = 7.26, l = 0)  # 11 * 0.66
      ),
      strip.text.x = NULL,
      strip.text.x.bottom = ggplot2::element_text(
        margin = ggplot2::margin(t = 2.75, r = 0, b = 11, l = 0)  # 11 * 0.25, 11 * 1
      ),
      strip.text.y = ggplot2::element_text(
        margin = ggplot2::margin(t = 0, r = 0, b = 0, l = 7.33),  # 11 * 2/3
        angle = -90
      ),
      strip.text.y.left = ggplot2::element_text(
        margin = ggplot2::margin(t = 0, r = 7.33, b = 0, l = 0),  # 11 * 2/3
        angle = 90
      ),
      ...
      plot.title = ggplot2::element_text(
        ...
        colour = title_colour,
        hjust = 0,
        margin = ggplot2::margin(b = 27.50)  # 11 * 2.5
      ),
      ...
      plot.subtitle = ggplot2::element_text(
        ...
        hjust = 0,
        margin = ggplot2::margin(b = 22)  # 11 * 2
      ),
      plot.caption = ggplot2::element_text(
        ...
        hjust = caption_hjust,
        margin = ggplot2::margin(t = 5.50, r = 0, b = 5.50, l = 0)  # 11 * 0.5
      ),
...
legend_place <- function(legend_place = "right",
  ...
  if (legend_place == "right") {
    ggplot2::theme(
      ...
      legend.spacing.y = grid::unit(16.50, "pt"),  # 11 * 1.5 rounded to 16.5
      legend.spacing.x = NULL,
      legend.key = ggplot2::element_rect(
        colour = legend_key_fill,
        fill = legend_key_fill
      ...
      plot.title = ggplot2::element_text(margin = ggplot2::margin(b = 5.50)),  # Already 5.5
      plot.subtitle = ggplot2::element_text(margin = ggplot2::margin(b = 16.50)),  # Already 16.5
      ...
      axis.title.y.right = ggplot2::element_text(margin = ggplot2::margin(t = 0, r = 0, b = 0, l = 5.50), angle = -90),  # Already 5.5
      axis.text.x = ggplot2::element_text(vjust = 1, margin = ggplot2::margin(t = 5.50, r = 0, b = 11, l = 0)),  # Already 5.5
      axis.text.x.top = ggplot2::element_text(vjust = 0, margin = ggplot2::margin(t = 0, r = 0, b = 5.50, l = 0))  # Already 5.5
    )
    ...
    ggplot2::theme(
      ...
      legend.title = ggplot2::element_text(margin = ggplot2::margin(t = 0, r = 0, b = 2.75, l = 0)),
      legend.byrow = TRUE,
      ...
      plot.title = ggplot2::element_text(margin = ggplot2::margin(b = 5.50)),  # Already 5.5
      plot.subtitle = ggplot2::element_text(margin = ggplot2::margin(b = 5.50)),  # Already 5.5

      axis.title.x = ggplot2::element_text(margin = ggplot2::margin(t = 0, r = 0, b = 4.62, l = 0)),
      axis.title.x.top = ggplot2::element_text(margin = ggplot2::margin(t = 0, r = 0, b = 5.50, l = 0)),  # Already 5.5
      axis.title.y = ggplot2::element_text(margin = ggplot2::margin(t = 0, r = 11, b = 0, l = 0), angle = 90),
      axis.title.y.right = ggplot2::element_text(margin = ggplot2::margin(t = 0, r = 0, b = 0, l = 5.50), angle = -90),  # Already 5.5
      axis.text.x = ggplot2::element_text(vjust = 0.5, margin = ggplot2::margin(t = 3.30, r = 0, b = 11, l = 0)),  # 11 * 0.3
      axis.text.x.top = ggplot2::element_text(vjust = 0.5, margin = ggplot2::margin(t = 0, r = 0, b = 3.30, l = 0))  # 11 * 0.3
    )
    ...
    ggplot2::theme(
      ...
      legend.box.just = "left",
      legend.box.margin = ggplot2::margin(t = 0, r = 0, b = 0, l = 0),
      legend.title = ggplot2::element_text(margin = ggplot2::margin(t = 2.75, r = 0, b = 5.50, l = 0)),  # Already 5.5
      legend.byrow = TRUE,
      legend.direction = "horizontal",
      legend.spacing = grid::unit(11, "pt"),
      legend.spacing.y = grid::unit(16.50, "pt"),  # 11 * 1.5
      ...
      axis.title.y = ggplot2::element_text(margin = ggplot2::margin(t = 0, r = 11, b = 0, l = 0), angle = 90),
      axis.title.y.right = ggplot2::element_text(margin = ggplot2::margin(t = 0, r = 0, b = 0, l = 5.50), angle = -90),  # Already 5.5
      axis.text.x = ggplot2::element_text(vjust = 1, margin = ggplot2::margin(t = 3.30, r = 0, b = 11, l = 0)),  # 11 * 0.3
      axis.text.x.top = ggplot2::element_text(vjust = 0, margin = ggplot2::margin(t = 0, r = 0, b = 3.30, l = 0))  # 11 * 0.3
    )
  }
}
