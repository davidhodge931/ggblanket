...
#'           if (geom == "label") pal_alpha <- 0.1
#'           else alpha_pal1 <- 0.9
#'         }
#'         else if (is.ggproto(geom)) {
#'           if (identical(geom, ggplot2::GeomLabel)) pal_alpha <- 0.1
#'           else alpha_pal1 <- 0.9
#'         }
#'         else alpha_pal1 <- 0.9
#'       }
...
#'           if (inherits(position[1], "PositionFill")) x_limits <- c(NA, NA)
#'         }
