...
gg_ribbon <- function(data = NULL,
  ...
  if (!rlang::quo_is_null(col)) rlang::inform(c("i" = "Note in {ggribbonet}, the {ggplot2} fill aesthetic inherits from col"))
  # if (rlang::is_null(position)) rlang::inform(c("i" = "Note {ggribbonet} gg_bar uses a default of 'dodge2', where {ggplot2} uses a default of 'stack'"))
