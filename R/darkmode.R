...
#'     y = body_mass_g,
#'     col = species,
#'     theme = darkmode_right2()
#'   )
#'
#' #set globally
#' \dontrun{
#'   theme_set(darkmode_right2())
#'
#'   penguins |>
#'     gg_point(
#'       x = flipper_length_mm,
...
darkmode_right2 <- function (
  ...
  ggplot2::theme(
    ...
    rect = ggplot2::element_rect(fill = pal_darkmode[2], colour = pal_darkmode[2], linewidth = base_size/33, linetype = 1),
    ...
    legend.key = ggplot2::element_rect(colour = pal_darkmode[2], fill = pal_darkmode[2]),
    ...
    legend.ticks = ggplot2::element_line(colour = pal_darkmode[2]),
    legend.ticks.length = NULL,
    legend.title.position = "top",
    legend.box = NULL,
    legend.box.background = NULL,
    legend.box.spacing = NULL,
    panel.background = ggplot2::element_rect(fill = pal_darkmode[3], colour = pal_darkmode[3]),
    panel.border = ggplot2::element_blank(),
    panel.grid = NULL,
    panel.grid.major = ggplot2::element_line(colour = pal_darkmode[4], linewidth = ggplot2::rel(0.5)),
    ...
    legend.text = ggplot2::element_text(margin = margin(t = 0, r = 0, b = 0, l = base_size * 0.5)),
    axis.title.x = ggplot2::element_text(margin = margin(t = base_size * -0.33, r = 0, b = base_size * 0.75, l = 0)),
...
#'     y = body_mass_g,
#'     col = species,
#'     theme = darkmode_right()
#'   )
#'
#' #set globally
#' \dontrun{
#'   theme_set(darkmode_right())
#'
#'   penguins |>
#'     gg_point(
#'       x = flipper_length_mm,
...
#'     y = body_mass_g,
#'     col = species,
#'     theme = darkmode_bottom()
#'   )
#'
#' #set globally
#' \dontrun{
#'   theme_set(darkmode_bottom())
#'
#'   penguins |>
#'     gg_point(
#'       x = flipper_length_mm,
...
darkmode_bottom <- function (
  ...
  ggplot2::theme(
    ...
    legend.title = element_text(margin = ggplot2::margin(t = base_size * 0.25, r = 0, b = base_size * 0.5, l = 0)),
    legend.text = element_text(margin = ggplot2::margin(t = base_size * 0.5, r = base_size * 1.25, b = base_size * 0.5, l = base_size * 0.5)),
    axis.text.x = ggplot2::element_text(margin = ggplot2::margin(t = base_size * 0.2, r = 0, b = base_size * 1, l = 0)),
    axis.title.x = ggplot2::element_text(margin = margin(t = base_size * -0.33, r = 0, b = base_size * 0.75, l = 0)),
    axis.title.x.top = ggplot2::element_text(margin = ggplot2::margin(t = base_size * -1, r = 0, b = base_size * 1, l = 0)),
    axis.text.x.top = ggplot2::element_text(margin = ggplot2::margin(t = base_size * -0.5, r = 0, b = base_size * 0.2, l = 0)),
...
darkmode_top <- function (
  ...
  ggplot2::theme(
    ...
    legend.title = element_text(margin = margin(t = base_size * 0.25, r = 0, b = base_size * 0.5, l = 0)),
    legend.text = element_text(margin = margin(t = base_size * 0.5, r = base_size * 1.25, b = base_size * 0.5, l = base_size * 0.5)),
    axis.text.x = ggplot2::element_text(margin = ggplot2::margin(t = base_size * 0.2, r = 0, b = base_size * 1, l = 0)),
    axis.title.x = ggplot2::element_text(margin = margin(t = base_size * -0.33, r = 0, b = base_size * 0.75, l = 0)),
...
#'     y = body_mass_g,
#'     col = species,
#'     theme = darkmode_inside(legend_position_inside = c(0.15, 0.7))
#'   )
#'
#' #set globally
#' \dontrun{
#'   theme_set(darkmode_inside())
#'
#'   penguins |>
#'     gg_point(
#'       x = flipper_length_mm,
...
darkmode_inside <- function (
  ...
  ggplot2::theme(
    ...
    legend.title = element_text(margin = margin(t = 0, r = 0, b = base_size * 0.5, l = 0)),
    legend.text = ggplot2::element_text(margin = margin(t = 0, r = base_size * 1, b = 0, l = base_size * 0.5)),
    legend.background = element_rect(colour = ggblanket:::pal_darkmode[4], fill = ggblanket:::pal_darkmode[2]),
    axis.text.x = element_text(margin = margin(t = base_size * 0.2, r = 0, b = base_size * 1, l = 0)),
    axis.title.x = ggplot2::element_text(margin = margin(t = base_size * -0.33, r = 0, b = base_size * 0.75, l = 0)),
    axis.title.x.top = ggplot2::element_text(margin = ggplot2::margin(t = base_size * -1, r = 0, b = base_size * 1, l = 0)),
    axis.text.x.top = ggplot2::element_text(margin = ggplot2::margin(t = base_size * -0.5, r = 0, b = base_size * 0.2, l = 0)),
    axis.title.y.right = ggplot2::element_text(margin = ggplot2::margin(t = 0, r = base_size * -0.5, b = 0, l = base_size * 1), angle = -90),
