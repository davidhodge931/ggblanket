...
#'
#' @param colour A hex colour. Defaults to `lightness[1]`. The default annotate fill inherits from annotate_colour.
#'
#' @noRd
weave_annotate_defaults <- function(colour = lightness[1]) {
