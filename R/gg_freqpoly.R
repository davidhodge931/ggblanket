...
#'
#' @description Create a freqpoly ggplot with a wrapper around the ggplot2::geom_freqpoly function.
...
#' @param ... Other arguments passed to the ggplot2::geom_freqpoly function.
