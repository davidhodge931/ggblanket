#' @title Label ggplot
#'
#' @description Create a label ggplot with a wrapper around the ggplot2::geom_label function.
...
#' @param ... Other arguments passed to the ggplot2::geom_label function.
