...
#'
#'   # Determine if this is a border geom (needs to happen after geom extraction in Step 3)
#'   # So this section should go after Step 3...
#'
...
#'   }
#'
#'   # Then after Step 3 (where geom is extracted), add the default handling:
#'
...
#'   }
#'
#'   # Apply border transformations to palettes
#'   if (border) {
...
#'   }
#'
#'   # Add defaults for non-mapped aesthetics that weren't provided
#'   # For colour
#'   if (!colour_detection$is_aesthetic && is.null(fixed_params$colour)) {
...
#'
#'   # For fill
#'   if (!fill_detection$is_aesthetic && is.null(fixed_params$fill)) {
