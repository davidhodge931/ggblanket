...
#' }
#'
#' # Alternative approach: Check the actual plot mapping after it's built
#' #' Check if colour and fill are mapped to same variable in plot
#' #' @noRd
#' check_same_colour_fill_mapping2 <- function(plot) {
...
#' }
#'
#' # Updated logic for add_col_scale_continuous
...
#'
#'     # Check if colour and fill map to the same variable
#'     same_mapping <- are_aesthetics_identical(aes_list$colour, aes_list$fill)
#'     colour_mapped <- !rlang::quo_is_null(aes_list$colour)
#'     fill_mapped <- !rlang::quo_is_null(aes_list$fill)
#'
#'     if (same_mapping) {
#'       # Same variable mapped to both - hide one guide
#'       if (border) {
