...
#' #' @param axis_linewidth The linewidth of the axis.line and axis.ticks theme elements.
...
#' #' @param non_panel_fill The fill (and colour) of the plot.background, legend.background, legend.key and strip.background theme elements.
#' #'
...
#'     legend.key = ggplot2::element_rect(colour = non_panel_fill, fill = non_panel_fill),
...
#'     legend.background = ggplot2::element_rect(colour = non_panel_fill, fill = non_panel_fill),
...
#'     plot.background = ggplot2::element_rect(colour = non_panel_fill, fill = non_panel_fill),
