...
#'
#' @param text_size The size of the text theme element. Defaults to 11.
#' @param text_family The family of the text theme element. Defaults to "".
#' @param text_face The face of the text theme element. Defaults to "plain".
#' @param text_colour The colour of the text theme element.
#' @param title_size The size of the plot.title theme element. Defaults to 11.
#' @param title_family The family of the plot.title theme element. Defaults to "".
#' @param title_face The face of the plot.title theme element. Defaults to "plain".
#' @param title_colour The colour of the plot.title theme element.
#' @param subtitle_size The size of the plot.subtitle theme element. Defaults to 11.
#' @param subtitle_family The family of the plot.subtitle theme element. Defaults to "".
#' @param subtitle_face The face of the plot.subtitle theme element. Defaults to "plain".
#' @param subtitle_colour The colour of the plot.subtitle theme element.
#' @param caption_size The size of the plot.caption theme element. Defaults to 11.
#' @param caption_family The family of the plot.caption theme element. Defaults to "".
#' @param caption_face The face of the plot.caption theme element. Defaults to "plain".
#' @param caption_colour The colour of the plot.caption theme element.
#' @param axis_colour The colour of the axis.line and axis.ticks theme elements.
#' @param axis_linewidth The linewidth of the axis.line and axis.ticks theme element.
#' @param grid_colour The colour of the panel.grid theme element.
#' @param grid_linewidth The linewidth of the panel.grid theme element.
#' @param panel_fill The fill (and colour) of the panel.background theme element.
#' @param plot_fill The fill (and colour) of the plot.background, legend.background and legend.key theme elements.
#'
#' @return A ggplot theme.
#' @keywords internal
#'
make_mode_base <- function(
    text_size = 11,
    text_family = "",
    text_face = "plain",
    ...
    axis_colour = lightness[2],
    axis_linewidth = linewidthness[1],
    grid_colour = lightness[3],
    grid_linewidth = linewidthness[2],
    panel_fill = lightness[4],
    plot_fill = lightness[5]
) {
  ...
  ggplot2::theme(
    ...
    axis.line = ggplot2::element_line(colour = axis_colour, linewidth = axis_linewidth),
    axis.line.x = NULL,
    axis.line.y = NULL,
    axis.text = NULL,
    ...
    axis.ticks = ggplot2::element_line(colour = axis_colour, linewidth = axis_linewidth),
    ...
    legend.key = ggplot2::element_rect(colour = plot_fill, fill = plot_fill),
    ...
    legend.background = ggplot2::element_rect(colour = plot_fill, fill = plot_fill),
    panel.background = ggplot2::element_rect(colour = panel_fill, fill = panel_fill),
    panel.border = ggplot2::element_blank(),
    panel.grid = ggplot2::element_line(colour = grid_colour, linewidth = grid_linewidth),
    ...
    plot.background = ggplot2::element_rect(colour = plot_fill, fill = plot_fill), #, linewidth = axis_linewidth
    ...
    plot.caption = ggplot2::element_text(size = caption_size, family = caption_family, face = caption_face, colour = caption_colour,
                                         hjust = 0, margin = ggplot2::margin(t = text_size * 0.5, r = 0, b = text_size * 0.5, l = 0)),
...
#'
#' @inheritParams make_mode_base
#' @param ... Provided to support trailing commas only.
#'
#' @return A ggplot theme.
#' @keywords internal
#'
make_mode_r <- function (
    text_size = 11,
    text_family = "",
    text_face = "plain",
    text_colour = lightness[1],
...
#'
#' @inheritParams make_mode_r
#'
#' @return A ggplot theme.
#' @keywords internal
#'
make_mode_t <- function (
    text_size = 11,
    text_family = "",
    text_face = "plain",
    text_colour = lightness[1],
