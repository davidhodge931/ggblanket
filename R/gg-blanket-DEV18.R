  ...
  if (x_type == "discrete") {
    ...
    plot <- plot +
      ggplot2::scale_x_continuous(
        ...
        guide = x_guide,
        labels = x_labels %||% get_labels(data, x_subtype, "x"),
        limits = x_limits,
        name = x_name,
        oob = x_oob,
        position = x_position,
  ...
  if (y_type == "discrete") {
    ...
    plot <- plot +
      ggplot2::scale_y_continuous(
        ...
        guide = y_guide,
        labels = y_labels %||% get_labels(data, y_subtype, "y"),
        limits = y_limits,
        name = y_name,
        oob = y_oob,
        position = y_position,
      ...
      if (fill_type == "continuous") {
        plot <- plot +
          ggplot2::continuous_scale(
            ...
            breaks = fill_breaks %||% ggplot2::waiver(),
            guide = fill_guide %||% ggplot2::guide_legend(),
            labels = fill_labels %||% get_labels(data, fill_subtype, "fill"),
            limits = fill_limits,
            name = fill_name,
            oob = fill_oob,
      ...
      if (colour_type == "continuous") {
        plot <- plot +
          ggplot2::continuous_scale(
            ...
            breaks = colour_breaks %||% fill_breaks,
            guide = colour_guide %||% fill_guide %||% ggplot2::guide_legend(),
            labels = colour_labels %||% fill_labels %||% get_labels(data, colour_subtype, "colour"),
            limits = colour_limits %||% fill_limits,
            name = colour_name %||% fill_name,
    ...
    if (alpha_type == "discrete") {
      ...
      plot <- plot +
        ggplot2::continuous_scale(
          ...
          breaks = alpha_breaks,
          guide = alpha_guide %||% ggplot2::guide_legend(),
          labels = alpha_labels %||% get_labels(data, alpha_subtype, "alpha"),
          limits = alpha_limits,
          name = alpha_name,
          oob = alpha_oob,
    ...
    if (size_type == "discrete") {
      ...
      plot <- plot +
        ggplot2::continuous_scale(
          ...
          breaks = size_breaks,
          guide = size_guide %||% ggplot2::guide_legend(),
          labels = size_labels %||% get_labels(data, size_subtype, "size"),
          limits = size_limits,
          name = size_name,
          oob = size_oob,
    ...
    if (linewidth_type == "discrete") {
      ...
      plot <- plot +
        ggplot2::continuous_scale(
          ...
          breaks = linewidth_breaks,
          guide = linewidth_guide %||% ggplot2::guide_legend(),
          labels = linewidth_labels %||% get_labels(data, linewidth_subtype, "linewidth"),
          limits = linewidth_limits,
          name = linewidth_name,
          oob = linewidth_oob,
