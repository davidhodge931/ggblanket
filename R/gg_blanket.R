...
gg_blanket <- function(
  ...
  if (stringr::str_detect(stat_name, "sf")) {
    plot <- plot +
      ...
      ggplot2::theme(axis.minor.ticks.x.top = ggplot2::element_blank()) +
      ggplot2::theme(axis.minor.ticks.x.bottom = ggplot2::element_blank()) +
      ...
      ggplot2::theme(axis.minor.ticks.y.left = ggplot2::element_blank()) +
      ggplot2::theme(axis.minor.ticks.y.right = ggplot2::element_blank()) +
