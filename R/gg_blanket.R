...
#' @param mode A `*_mode_*` theme (e.g. [grey_mode_b()], [grey_mode_rt()], or [dark_mode_rt()]). This argument automatically removes gridlines/axis-line/ticks. To avoid these side-effects, `+` your theme on as a layer.
