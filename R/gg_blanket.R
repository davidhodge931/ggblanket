...
gg_blanket <- function(
  ...
  ggplot2::update_geom_defaults("density2d", ggplot2::aes(colour = NA, fill = blue))
  ggplot2::update_geom_defaults("density_2d_filled", ggplot2::aes(colour = blue, fill = blue))
  ...
  #to be adjusted once ggplot makes GeomBin2d
