...
gg_blanket <- function(
  ...
  ggplot2::update_geom_defaults("abline", ggplot2::aes(colour = blue, fill = blue, linewidth = 0.75))
  ...
  ggplot2::update_geom_defaults("contour", ggplot2::aes(colour = blue))
  ggplot2::update_geom_defaults("contour_filled", ggplot2::aes(fill = blue))
  ...
  ggplot2::update_geom_defaults("density2d", ggplot2::aes(colour = blue))
  ggplot2::update_geom_defaults("density_2d_filled", ggplot2::aes(fill = blue))
  ggplot2::update_geom_defaults("errorbar", ggplot2::aes(colour = blue, width = 0.1))
  ggplot2::update_geom_defaults("function", ggplot2::aes(colour = blue, linewidth = 0.75))
  ...
  ggplot2::update_geom_defaults("line", ggplot2::aes(colour = blue, linewidth = 0.75))
  ggplot2::update_geom_defaults("linerange", ggplot2::aes(colour = blue, linewidth = 0.75))
  ggplot2::update_geom_defaults("path", ggplot2::aes(colour = blue, linewidth = 0.75))
  ggplot2::update_geom_defaults("point", ggplot2::aes(colour = blue, fill = blue))
  ggplot2::update_geom_defaults("pointrange", ggplot2::aes(colour = blue, fill = blue, linewidth = 0.75, size = 0.33))
  ggplot2::update_geom_defaults("polygon", ggplot2::aes(colour = blue, fill = blue, alpha = 0.9))
  ggplot2::update_geom_defaults("quantile", ggplot2::aes(colour = blue))
  ...
  ggplot2::update_geom_defaults("ribbon", ggplot2::aes(colour = blue, fill = blue, alpha = 0.4))
  ggplot2::update_geom_defaults("rug", ggplot2::aes(colour = blue))
  ggplot2::update_geom_defaults("segment", ggplot2::aes(colour = blue))
  ggplot2::update_geom_defaults("sf", ggplot2::aes(colour = blue, fill = blue, alpha = 0.9))
  ggplot2::update_geom_defaults("smooth", ggplot2::aes(colour = blue, fill = blue, linewidth = 0.75))
  ggplot2::update_geom_defaults("spoke", ggplot2::aes(colour = blue))
  ggplot2::update_geom_defaults("step", ggplot2::aes(colour = blue, linewidth = 0.75))
  ...
  ggplot2::update_geom_defaults("tile", ggplot2::aes(colour = NA, fill = blue, alpha = 0.9, linewidth = 0.5))
