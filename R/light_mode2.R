...
light_mode_rt <- function (
  ...
  ggplot2::theme(
    line = ggplot2::element_line(colour = lightness[1], linewidth = base_size/33, linetype = 1, lineend = "square"),
    rect = ggplot2::element_rect(fill = lightness[3], colour = lightness[3], linewidth = base_size/33, linetype = 1),
    text = ggplot2::element_text(family = base_family, face = "plain", colour = lightness[1], size = base_size,
    ...
    legend.key = ggplot2::element_rect(colour = lightness[3], fill = lightness[3]),
    ...
    legend.ticks = ggplot2::element_line(colour = lightness[3]),
    legend.ticks.length = grid::unit(base_size / 3.25, "pt"),
    legend.title.position = "top",
    legend.box = NULL,
    legend.box.background = NULL,
    legend.box.spacing = NULL,
    panel.background = ggplot2::element_rect(fill = lightness[2], colour = lightness[2]),
    panel.border = ggplot2::element_blank(),
    panel.grid = NULL,
    panel.grid.major = ggplot2::element_line(colour = lightness[3], linewidth = ggplot2::rel(0.5)),
    ...
    plot.title = ggplot2::element_text(family = NULL, face = "plain", colour = NULL, size = ggplot2::rel(1.1), hjust = 0, vjust = 0.5, margin = ggplot2::margin(t = base_size * -1, r = 0, b = base_size * 2.5, l = 0)),
    plot.title.position = "plot",
    plot.subtitle = ggplot2::element_text(family = NULL, face = NULL, colour = NULL, size = NULL, hjust = 0, vjust = 0.5, margin = ggplot2::margin(t = base_size * -2, r = 0, b = base_size * 2, l = 0)),
    plot.caption = ggplot2::element_text(family = NULL, face = NULL, colour = scales::alpha(lightness[1], 0.33), size = ggplot2::rel(0.9), hjust = 0, vjust = 0.5, margin = ggplot2::margin(t = base_size * 0.5, r = 0, b = base_size * 0.5, l = 0)),
...
light_mode_i <- function (
  ...
  ggplot2::theme(
    ...
    legend.background = ggplot2::element_rect(colour = lightness[3], fill = lightness[3]),
    axis.text.x = ggplot2::element_text(vjust = 1, margin = ggplot2::margin(t = base_size * 0.2, r = 0, b = base_size * 1, l = 0)),
    axis.title.x = ggplot2::element_text(margin = ggplot2::margin(t = base_size * -0.33, r = 0, b = base_size * 0.75, l = 0)),
    axis.title.x.top = ggplot2::element_text(margin = ggplot2::margin(t = base_size * -1, r = 0, b = base_size * 1, l = 0)),
    axis.text.x.top = ggplot2::element_text(vjust = 0, margin = ggplot2::margin(t = base_size * -0.5, r = 0, b = base_size * 0.2, l = 0)),
