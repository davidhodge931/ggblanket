...
#' #' @param flipped TRUE or FALSE of whether the plot is flipped. Defaults to NULL, which guesses.
...
#'
#'       if (rlang::is_null(x_expand)) x_expand <- c(0.05, 0.05)
#'
#'       if (rlang::is_null(x_breaks)) {
