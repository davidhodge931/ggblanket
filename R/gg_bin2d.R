#' Bin2d ggplot
#'
#' @description Create a bin2d ggplot with a wrapper around [ggplot()][ggplot2::ggplot()] + [layer()][ggplot2::layer()] with [geom_bin2d()][ggplot2::geom_bin2d()] defaults for the geom, stat and position.
#'
