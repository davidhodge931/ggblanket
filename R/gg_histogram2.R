...
#' @param pal Colours to use. A character vector of histogram codes (or names).
#' @param pal_na Colour to use for NA values. A character vector of a histogram code (or name).
