...
#     else if (x_transform_name %in% c("time", "date")) x_labels <- scales::label_date_short()
...
#   else if (any(x_transform_name == "time")) x_vctr <- lubridate::as_datetime(x_vctr, origin = "1970-01-01")
...
#     if (any(x_transform_name %in% c("hms", "time", "date"))) {
