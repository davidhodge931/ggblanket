...
#' @param panel_background_colour The colour of the panel.background theme element. Fill inherits from this.
#' @param plot_background_colour The colour of the plot.background, legend.background, strip.background, and legend.key theme elements. Fill inherits from this.
...
get_mode_base <- function(
  ...
  ggplot2::theme(
    ...
    plot.caption = ggplot2::element_text(colour = scales::alpha(text_colour, 0.75), size = ggplot2::rel(0.85), hjust = 0, margin = ggplot2::margin(t = base_size * 0.5, r = 0, b = base_size * 0.5, l = 0)),
