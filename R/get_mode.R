...
#' @param base_colour A colour of the text theme element. The caption colour is scales::alpha(base_colour, 0.75).
...
get_mode_base <- function(
  ...
  ggplot2::theme(
    text = ggplot2::element_text(family = base_family, face = "plain", colour = base_colour, size = base_size,
    ...
    plot.caption = ggplot2::element_text(colour = scales::alpha(base_colour, 0.75), size = ggplot2::rel(0.85), hjust = 0, margin = ggplot2::margin(t = base_size * 0.5, r = 0, b = base_size * 0.5, l = 0)),
