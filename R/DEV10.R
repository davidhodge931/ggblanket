...
gg_blanket <- function(
  ...
  if (
    (
      ...
      # (!identical(rlang::eval_tidy(y, data), rlang::eval_tidy(alpha, data)))
    ) &
    flipped) {
  ...
  #     linetype_title <-
  #       purrr::map_chr(rlang::as_name(plot_build$plot$labels$linetype[1]),
  #                      titles)
  #   }
  # }
  ...
  #     linewidth_title <-
  #       purrr::map_chr(rlang::as_name(plot_build$plot$labels$linewidth[1]),
  #                      titles)
  #   }
  # }
  ...
  #     shape_title <-
  #       purrr::map_chr(rlang::as_name(plot_build$plot$labels$shape[1]), titles)
  #   }
  # }
  # if (rlang::is_null(size_title)) {
  #   if (!rlang::is_null(plot_build$plot$labels$size)) {
  #     size_title <-
  #       purrr::map_chr(rlang::as_name(plot_build$plot$labels$size[1]), titles)
  #   }
  # }
