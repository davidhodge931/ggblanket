...
test_that("breaks_cont_fn", {
  expect_doppelganger("breaks_cont_fn",
...
test_that("breaks_disc_vec", {
  expect_doppelganger("breaks_disc_vec",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_point(
                          x = species,
...
test_that("breaks_disc_named", {
  expect_doppelganger("breaks_disc_named",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_point(
                          x = species,
...
test_that("labels_disc", {
  expect_doppelganger("labels_disc",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_point(
                          x = species,
...
test_that("labels_cont", {
  expect_doppelganger("labels_cont",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_point(
                          x = bill_depth_mm,
...
test_that("expand_disc_zero", {
  expect_doppelganger("expand_disc_zero",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_point(
                          x = species,
...
test_that("expand_cont_asym", {
  expect_doppelganger("expand_cont_asym",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_point(
                          x = bill_depth_mm,
...
test_that("limits_include", {
  expect_doppelganger("limits_include",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_point(
                          x = bill_depth_mm,
...
test_that("titles_all", {
  expect_doppelganger("titles_all",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_point(
                          x = bill_depth_mm,
...
test_that("pos_disc_tr", {
  expect_doppelganger("pos_disc_tr",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_point(
                          x = island,
...
test_that("pos_cont_tr", {
  expect_doppelganger("pos_cont_tr",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_point(
                          x = bill_depth_mm,
...
test_that("sec_axis_cont", {
  expect_doppelganger("sec_axis_cont",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_point(
                          x = bill_depth_mm,
...
test_that("sec_axis_disc", {
  expect_doppelganger("sec_axis_disc",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_point(
                          x = species,
...
test_that("trans_reverse", {
  expect_doppelganger("trans_reverse",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_point(
                          x = bill_depth_mm,
...
test_that("symmetric_x", {
  expect_doppelganger("symmetric_x",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_point(
                          x = bill_depth_mm,
...
test_that("leg_rev_disc", {
  expect_doppelganger("leg_rev_disc",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_point(
                          x = species,
...
test_that("leg_rev_cont", {
  expect_doppelganger("leg_rev_cont",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_point(
                          x = bill_depth_mm,
...
test_that("border_false", {
  expect_doppelganger("border_false",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_point(
                          x = bill_depth_mm,
...
test_that("violin_jit_border", {
  set.seed(123)
  expect_doppelganger("violin_jit_border",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_violin(
                          x = island,
...
test_that("violin_jit_no_bord", {
  set.seed(123)
  expect_doppelganger("violin_jit_no_bord",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_violin(
                          x = island,
...
test_that("pal_cont_viridis", {
  expect_doppelganger("pal_cont_viridis",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_point(
                          x = bill_depth_mm,
...
test_that("pal_disc_violin", {
  expect_doppelganger("pal_disc_violin",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_violin(
                          x = island,
...
test_that("pal_disc_viridis", {
  expect_doppelganger("pal_disc_viridis",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_point(
                          x = bill_depth_mm,
...
test_that("leg_nrow_2", {
  expect_doppelganger("leg_nrow_2",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_point(
                          x = bill_depth_mm,
...
test_that("leg_ncol_2", {
  expect_doppelganger("leg_ncol_2",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_point(
                          x = bill_depth_mm,
...
test_that("leg_keep_all", {
  expect_doppelganger("leg_keep_all",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
...
test_that("leg_drop_unused", {
  expect_doppelganger("leg_drop_unused",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        dplyr::filter(species != "Adelie") |>
                        gg_point(
...
test_that("steps_breaks_n", {
  expect_doppelganger("steps_breaks_n",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_point(
                          x = bill_depth_mm,
...
test_that("steps_breaks_width", {
  expect_doppelganger("steps_breaks_width",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_point(
                          x = bill_depth_mm,
...
test_that("annotate_axis", {
  expect_doppelganger("annotate_axis",
                      palmerpenguins::penguins |>
                        tidyr::drop_na() |>
                        gg_blanket(
                          x = bill_depth_mm,
...
test_that("contour_filled", {
  expect_doppelganger("contour_filled",
                      faithfuld |>
                        gg_contour_filled(
                          x = waiting,
                          y = eruptions,
