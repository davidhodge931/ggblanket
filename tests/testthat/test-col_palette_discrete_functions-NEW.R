...
test_that("disc_col_trans", {
  ...
  expect_doppelganger("disc_dark_hue_jit",
  ...
  expect_doppelganger("disc_dark_hue_vio",
                      palmerpenguins::penguins |>
                        gg_violin(
                          x = species,
                          y = body_mass_g,
...
test_that("disc_sep_col_fill", {
  ...
  expect_doppelganger("disc_dark_light_vio",
                      palmerpenguins::penguins |>
                        gg_violin(
                          x = species,
                          y = body_mass_g,
  ...
  expect_doppelganger("disc_dark_light_vio_rev",
                      palmerpenguins::penguins |>
                        gg_violin(
                          x = species,
                          y = body_mass_g,
...
test_that("disc_flip_orient", {
  ...
  expect_doppelganger("disc_flip_vio",
                      palmerpenguins::penguins |>
                        gg_violin(
                          x = body_mass_g,
                          y = species,
  ...
  expect_doppelganger("disc_flip_vio_rev",
                      palmerpenguins::penguins |>
                        gg_violin(
                          x = body_mass_g,
                          y = species,
...
test_that("disc_override", {
  ...
  expect_doppelganger("disc_base_vio",
                      palmerpenguins::penguins |>
                        gg_violin(
                          x = body_mass_g,
                          y = species,
  ...
  expect_doppelganger("disc_over_col",
                      palmerpenguins::penguins |>
                        gg_violin(
                          x = body_mass_g,
                          y = species,
  ...
  expect_doppelganger("disc_over_fill",
                      palmerpenguins::penguins |>
                        gg_violin(
                          x = body_mass_g,
                          y = species,
  ...
  expect_doppelganger("disc_over_both_trans",
                      palmerpenguins::penguins |>
                        gg_violin(
                          x = body_mass_g,
                          y = species,
...
test_that("disc_no_blanket", {
  ...
  expect_doppelganger("disc_no_bl_col",
                      palmerpenguins::penguins |>
                        gg_violin(
                          x = body_mass_g,
                          y = species,
  ...
  expect_doppelganger("disc_no_bl_fill",
                      palmerpenguins::penguins |>
                        gg_violin(
                          x = body_mass_g,
                          y = species,
  ...
  # Override both with transformations
  expect_doppelganger("disc_no_bl_both_trans",
                      palmerpenguins::penguins |>
                        gg_violin(
                          x = body_mass_g,
                          y = species,
