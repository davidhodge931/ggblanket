...
test_that(test_name, {
  ...
  p <- penguins |>
    ...
    gg_point(
      ...
      mode = light_mode_rt(base_family = "grace")
    ) +
    theme(
...
test_that(test_name, {
  p <- stars::read_stars(system.file("tif/L7_ETMs.tif", package = "stars")) |>
    tibble::as_tibble() |>
    gg_raster(
      x = x,
      y = y,
...
test_that(test_name, {
  p <- mpg |>
    ...
    gg_point(
      ...
      y = hwy,
      col = centred,
      col_pal = rev(RColorBrewer::brewer.pal(9, "RdBu")),
