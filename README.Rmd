...
5. provides customisable x and y scales that look nice by default
...
5. {ggblanket} provides customisable x and y scales that look nice by default
...
Hopefully, this is not too magical. But, I think this is a way to create a graph that visually has nice symmetry, and is vital to the look and feel of {ggblanket}. 
...
Available arguments are `*_limits`, `*_expand`, `*_labels`, `*_breaks`, `*_include`,  and `col_intervals` arguments.
