...
The `gg_theme` function allows you to create a quick theme that looks similar to the {ggblanket} look and feel. 

This includes the following arguments:

* `grid_h` and `grid_v`: arguments for adding horizontal and vertical gridlines
