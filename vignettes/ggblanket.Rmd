...
Note the last colour of the jumble palette is the same as the default discrete NA colour. So it won't work if you wish to plot 7 values/levels _and_ NA values. 

`jumble` is most accessible on a light background.
