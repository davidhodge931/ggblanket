...
you can use `alpha = 0` for the filled interior.

For turning off coloured outlines or changing the colour of the interior or outlines, you need a `col` aesthetic
