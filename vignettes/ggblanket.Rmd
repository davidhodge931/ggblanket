...
By using the `theme` argument, your theme will control all theme aspects, but with some magic relating to the legend position/direction and gridline removal. The gridline removal means that it is useful to provide a theme with major gridlines in both directions.

If you prefer to have your `theme` adjust _everything_, then add your theme as a layer instead (e.g. `+ theme_grey()`). 
