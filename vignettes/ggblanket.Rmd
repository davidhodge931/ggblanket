...
Use ggplot2 to remove a title nicely. E.g. `+ ggplot2::theme(legend.title = ggplot2::element_blank())` or `+ ggplot2::labs(... = NULL)`.

Remember the `col` aesthetic contains a title for colour and fill in ggplot2.
