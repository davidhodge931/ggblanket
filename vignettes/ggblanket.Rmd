...
`gg_*` functions do not directly support aesthetics of `alpha`, `size`, `linewidth`, `shape`, and `linetype`. However, you can use `gg_blank`, if you wish to in a slightly hacky way. Note this is easier and works better for plots with a col aesthetic. 
