...
Note If you wish to set the theme to `ggplot2::theme_grey` with the default `base_size` of 11, then you must it adjust it slightly (e.g. `theme_set(theme_grey(11.01)))`. This is due to `gg_*()`  functions changing the theme to `light_mode`, if no theme is set and the global theme is `theme_grey`.
