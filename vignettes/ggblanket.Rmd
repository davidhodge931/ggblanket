...
8. Ability to set the theme, including with provided themes
...
Note If you wish to set the theme to `ggplot2::theme_grey` with the default `base_size` of 11, then you must it adjust it slightly (e.g. `theme_set(theme_grey(11.01)))`. This is due to the hack of how theme_set has been made to work with ggblanket.
