...
3.  The `col` aesthetic is hijacked to be both colour and fill
...
In ggblanket, the `col` aesthetic is hijacked to instead represent *both* the `colour` *and* the `fill` aesthetic.
