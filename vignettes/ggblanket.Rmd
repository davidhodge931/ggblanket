...
6.  Numerous prefixed arguments to customise 
7.  Default sentence case titles 
8.  `light_mode_*` and `dark_mode_*` theme families
9.  Pretty default continuous axis scales with opt-out
10. Helpful default `*_gridlines` removal
11. Access to other `geom_*` arguments via ...
12. Flexibility to turn-off or fix either colour or fill
...
Default `x`, `y`, `col` and `alpha` titles are converted to sentence case with `snakecase::to_sentence`. 
...
### 10.  Helpful default gridlines removal
