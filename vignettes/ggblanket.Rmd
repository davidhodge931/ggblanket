...
The scales are built within the `gg_*()` function _without_ knowledge of later geom layers. So users will need to take care in some situations to accommodate this within the `gg_*()` function. 
