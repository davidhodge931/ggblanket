...
These functions were built for use within `set_blanket`, as then `colour_bordered_transform` and `fill_bordered_transform` adjustments can apply based on these (e.g. if the panel is dark). 
