...
Three theme functions are provided to allow users to quickly adjust the default ggblanket theme: `gg_theme_light`, `gg_theme_dark` and `gg_theme_void`. A key argument to adjust is the text_size. The themes also contain other arguments to change the title, subtitle, caption, other text, background colours, axis lines and ticks, and gridlines. 
