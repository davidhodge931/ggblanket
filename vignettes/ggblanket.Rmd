...
Where it guesses `x_orientation = TRUE` and there is a continuous y scale, it will make this y scale 'symmetric' if possible with the `y_limits` the range of `y_breaks` and `y_expand` of `c(0, 0)`. The vice-versa will occur where it guesses `y_orientation = TRUE`.
