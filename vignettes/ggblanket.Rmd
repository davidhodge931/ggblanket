...
ggblanket creates a special continuous y scale for non-horizontal  plots that has: 

* `y_limits` that are the range of the `y_breaks` 
* `y_expand` of c(0, 0)

This special case can be turned off using `y_limits = c(NA, NA)`.

The opposite occurs for horizontal plots on the x scale. 
