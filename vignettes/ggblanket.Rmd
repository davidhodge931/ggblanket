...
Where legends do not align or merge nicely, you may need to reverse a variable, change a title with a `ggplot2::labs` layer, or change legend values by adding a  `ggplot2::scale_*_manual` layer etc.
