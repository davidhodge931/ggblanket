...
The `set_blanket` function is used to set the default style of subsequent  ggblanket plots. This includes setting the default mode and geom defaults. You can also use `ggplot2::update_geom_defaults` to further fine-tune your geom defaults.
