...
The scales are built within the `gg_*()` function _without_ knowledge of later geom layers. So users will sometimes need to take extra care in some situations to accommodate this in the `gg_*()` function. 
