...
* make plots with other non-supported aesthetics, i.e. `shape`, `linetype`, `alpha`, `size`, and `linewidth` 
...
Extending ggblanket with `gg_blank` might feel a bit hacky - it might be easier just to use ggplot2 in some situations. 
