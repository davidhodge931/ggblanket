...
These are built for use with the `mode` argument in the `gg_*` functions, which has helpful side-effects for different orientations.
...
### 14. Customise the setup with `set_blanket`
