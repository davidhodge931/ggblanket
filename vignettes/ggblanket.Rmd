...
Three theme functions are provided to help users create a quick clean looking theme: `gg_theme_light` (the default), `gg_theme_dark` and `gg_theme_void`. A key argument to adjust is the text_size. The themes also contain numerous other arguments to change the title, subtitle, caption, other text, background colours, axis lines and ticks, and gridlines. 
