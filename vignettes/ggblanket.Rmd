...
These are built for use with the `mode` argument in the `gg_*` functions, which has  side-effects for x and y orientations (i.e. removing particular axis lines/ticks and gridlines). 
