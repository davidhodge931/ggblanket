...
This is intended to make it quicker to get to a plot that has titles that are good for external people to see.
...
* Creating quick interactive plots with plotly::ggplotly
