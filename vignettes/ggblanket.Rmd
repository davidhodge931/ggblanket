...
Other aeesthetics are available: `alpha`, `size`, `shape`, `linetype` and `linewidth`.

The `mapping` argument is also provided for use with `ggplot2::after_stat`. 
...
The `set_blanket` function sets customisable defaults. Users should try to do as much as possible in this function, rather than continually add arguments to `gg_*` functions.
