...
The `gg_*()` function should also be appropriate to be the bottom layer of the plot. Subsequently, you may sometimes need to use `gg_blanket()` which defaults to a `blank` geom.
