...
Each `gg_*` function wraps a ggplot2 `ggplot(aes(...))` function with the applicable ggplot2 `geom_*()` function. All aesthetics are placed directly in the `gg_*` function: they are not within a `ggplot2::aes` function. See the [Functions demo](https://davidhodge931.github.io/ggblanket/articles/functions_demo.html) article for an example of each of the functions available.
