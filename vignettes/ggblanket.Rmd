...
`mode_set` sets the theme globally with these side-effects - and `ggplot2::theme_set` sets it globally without these side-effects. Use `mode_set(light_mode_rt())` or `theme_set(theme_grey())` to unset.
