...
The `gg_*` function adds helpful side-effects to the theme based on the `aspect`, `aspect_axis_line_transparent`, `aspect_axis_ticks_transparent` and , `aspect_panel_grid_transparent` arguments. 
...
If the `gg_*` guesses an incorrect `aspect`, then the user can change this. The user can set these side-effects in `set_blanket` by setting `aspect_axis_line_transparent`, `aspect_axis_ticks_transparent` or , `aspect_panel_grid_transparent` to `FALSE`.
