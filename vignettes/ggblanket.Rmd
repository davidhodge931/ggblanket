...
For titles that you need to change manually, you can change manually using `x_title`, `y_title`, or `col_title`. To remove titles, you can use `x_title = ""` within the `gg_*` function and equivalent for the y and col titles. 
