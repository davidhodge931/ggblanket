...
Note at the start of every script, the `set_blanket` function should be run to set the style for all subsequent ggblanket plots. 
...
The `set_blanket` function is used to set the default style of subsequent  ggblanket plots.
