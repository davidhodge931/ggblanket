...
* set limits to the range of the data using `*_limits = c(NA, NA)` (and `*_expand = c(0.05, 0.05)` if desired)
* use the `str_keep_seq` helper function to only keep every 2nd (or nth) label, and add more frequent breaks (e.g. `*_breaks = scales::breaks_pretty(10)`)
