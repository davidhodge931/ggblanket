...
These prefixes are designed to work nicely with the Rstudio autocomplete. It is recommended that users they have their Rstudio settings to support this, by ensuring that their settings support the use of tab for autocompletions and multi-line autocompletions (i.e. Tools - Global Options - Code - Completion). With these options selected, users can type the prefix, and then use the tab and arrow keys to assist in finding and selecting the arguments they need to adjust.
