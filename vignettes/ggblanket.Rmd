...
See the [Extending further article](https://davidhodge931.github.io/ggblanket/articles/extending_further.html) for further discussion and example code.

## Further information

See the [functions demo article](https://davidhodge931.github.io/ggblanket/articles/functions_demo.html) for an example of each of the functions available.
