...
* `ggblanket::pal_discrete` for a discrete `col` variable with 6 or less levels or unique values. Testing suggests this is red/green colourblind-safe.
* `scales::hue_pal` for a discrete `col` variable with more than 6 levels or unique values.
