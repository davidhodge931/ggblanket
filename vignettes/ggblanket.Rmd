...
14. A `gg_blanket` function for any exported `geom`
...
The ggblanket package contains a powerful `gg_blanket` function that enables the user to specify any exported geom. 
