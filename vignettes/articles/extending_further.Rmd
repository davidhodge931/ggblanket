...
penguins |>
  gg_point(
    ...
    theme = theme_light_mode(base_family = "grace", base_size = 12))
...
penguins |>
  gg_blank(
    ...
    theme = theme_light_mode(title_face = "plain")
    ) +
...
p <- diamonds |>
  gg_bar(
    ...
    col = color,
    width = 0.75,
    theme = theme_light_mode(base_family = "helvetica")) 
...
p <- diamonds |>
  gg_blank(
    ...
    y_include = 0,
    stat = "count", 
    theme = theme_light_mode(base_family = "helvetica", base_size = 9)) +
