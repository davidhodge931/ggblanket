...
A method developed by @teunbrand [here](https://github.com/teunbrand/ggplot_tricks) can be used to colour text based on the lightness of underlying polygons.  
