...
The `plotly::ggplotly` function enables interactive plots. The `text` aesthetic can be used to customise tooltips where the stat is "identity". Alternatively, use `plotly::ggplotly(p, tooltip = c("x", "y", "fill"))` or `plotly::ggplotly(p)`.
