...
8. Create custom wrapper functions
...
ggblanket can visualise vector and array data using the `gg_sf` and `gg_raster` functions. 
...
p <- diamonds |>
  gg_blank(
    ...
    y_include = 0,
    stat = "count", 
    theme = gg_theme(text_family = "helvetica", text_size = 9)) +
