...
4. Creating quick interactive plots with plotly::ggplotly
5. make plots with other non-supported aesthetics
6. use other non-supported arguments within ggplot2 layers
7. make plots with multiple geom layers
8. create custom functions that wrap ggblanket functions
...
```{r, echo = FALSE}
knitr::include_graphics("screenshot_ggplotly.png", dpi = 300)
```
...
### 6. use non-supported arguments within ggplot2 layers
