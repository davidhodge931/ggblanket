...
penguins2 |> 
  gg_blank(x = species, 
           y = body_mass_g) + 
  ggbeeswarm::geom_quasirandom(colour = "steelblue4")
```
...
d |>
  ...
  ggdist::stat_slabinterval(
    aes(dist = dist),
    colour = "steelblue4",
    fill = scales::alpha("steelblue4", 0.5))
```
...
p1 <- pressure |>
  ...
  geom_textline(
    ...
    size = 3.53, vjust = -0.5, hjust = 0.9, color = "steelblue4", linecolor = "steelblue4")
