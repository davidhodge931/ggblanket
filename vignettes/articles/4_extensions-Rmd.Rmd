...
penguins2 |> 
  gg_blank(x = species, 
           y = body_mass_g) + 
  ggbeeswarm::geom_quasirandom(colour = "steelblue")
```
...
d |>
  ...
  ggdist::stat_slabinterval(
    aes(dist = dist),
    colour = "steelblue",
    fill = scales::alpha("steelblue", 0.5))
```
...
ggplot2::economics |>
  ...
  ggforce::geom_bspline(n = 1000, colour = "steelblue")
```
...
penguins2 |>
  gg_point(
    ...
    subtitle = "<span style = 'color: #2596be ;'>**Adelie**</span>, 
       ...
       *and* <span style = 'color:#125162;'>**Gentoo**</span>", 
...
p1 <- pressure |>
  ...
  geom_textline(
    ...
    size = 3.53, vjust = -0.5, hjust = 0.9, color = "steelblue", linecolor = "steelblue")
