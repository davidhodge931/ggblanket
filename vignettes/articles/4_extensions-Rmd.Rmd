...
The patchwork package enables plots to be patched together. A convenient hack you can do with ggblanket is add a string to the facet variable to add a title for a non-faceted plot. Note that this will reduce the default `*_breaks`.
