...
A convenient hack to add a centred title in a non-faceted plot is to add a title string to the `facet` argument. Note this will reduce the default `*_breaks`.
