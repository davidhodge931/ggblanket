...
Most functions have the commonly needed aesthetics directly available as an argument. For those that are not available, you can either use `mapping` argument. The `mapping` argument provides access to the `linetype`, `shape` and `size` aesthetics within the `gg_*` function. 
