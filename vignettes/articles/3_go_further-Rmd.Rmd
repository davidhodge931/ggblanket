...
The `mapping` argument provides access to the `linetype`, `shape` and `size` aesthetics within the `gg_*` function. Note the `colour`, `fill` and `alpha` aesthetics cannot be added within the ggblanket `mapping` argument. 
