...
Text labels can be coloured based on the lightness/darkness of underlying polygons using a method developed by @teunbrand [here](https://github.com/teunbrand/ggplot_tricks).  
