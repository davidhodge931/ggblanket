...
Users can also fix _either_ the colour (i.e. of the outlines) or fill of a geom to something different than the `pal`. A method for where there is a `col` variable is to add a `colour = "black"` or `fill = "lightgrey"` argument. If no col variable is desired, just use `col = 1` and `col_legend_place = "none"`.
