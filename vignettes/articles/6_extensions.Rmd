...
economics_long |>
  gg_blanket(
    ...
    mapping = aes(
      ...
      pattern_fill2 = variable
    ),
    outline.type = "upper",
    x_expand = c(0, 0),
  ) +
  scale_pattern_fill_manual(
    values = rep(grey, times = length(unique(economics_long$variable))),
    guide = guide_none(),
  ) +
  scale_pattern_fill2_hue() +
  labs(pattern_fill2 = "Variable") +
  scale_colour_hue() 
```
