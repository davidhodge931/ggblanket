...
9. Use `+ *_mode_*` where we axis-lines and gridlines are not correct
...
Sometimes the plot might guess the orientation of the plot incorrectly - which affects the axis-line/ticks and gridlines removal. In these situations, you can `+ *_mode_*` on to the plot, and then remove any unwanted gridlines and axis-line/ticks.
