...
12. Use label attributes to set default `*_label` values.
...
The labelled package and others provide tools to set label attributes associated with variables.

These then form the default `*_label` value in ggblanket.
...
penguins_labelled |>
  ...
  copy_labels_from(penguins_labelled) |> 
  gg_col(
    x = flipper_length_mm,
    y = species,
    col = sex, 
