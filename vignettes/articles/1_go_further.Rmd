...
4. Use `+ *_mode_*` where axis-lines and gridlines are not as wanted
...
13. Make custom `gg_*` wrapper functions
14. Use character inputs of variables in shiny apps
15. Change the `*_position` of positional axes 
