...
Text on polygons can be coloured with a dark or light colour that is determined based on the underlying polygon colour using `!!!aes_contrast_mode()`. This method was developed by Teun van den Brand (@teunbrand).  
