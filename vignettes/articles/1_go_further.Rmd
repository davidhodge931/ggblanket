...
You may wish to make your own wrapper functions if you are continually adding the same defaults to your `gg_*` functions. Remember `mode_set` and `ggplot2::theme_set` are available to set the theme. 
