...
Alternatively, use `ggplot2::theme_set` to set a complete theme globally with no side-effects. This will result in the set theme `+`-ed on as the final layer to the `gg_*` output. You can unset this using `theme_set(theme_grey())`. 
