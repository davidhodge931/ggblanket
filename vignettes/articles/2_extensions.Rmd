...
The ggtext package support using markdown in text. The mdthemes package makes it easy to convert `ggplot2::element_text` to `ggtext::element_markdown` in themes.
