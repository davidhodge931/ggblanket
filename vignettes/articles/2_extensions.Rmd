...
This article will demonstrate some fantastic ggplot2 extension packages. It may be easier to just use ggplot2 instead of ggblanket in some cases. 
...
The ggpattern package supports patterns on polygons. Note legends must be aligned across aesthetics, if they are to merge.
