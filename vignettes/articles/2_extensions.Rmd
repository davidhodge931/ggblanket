...
penguins2 |>
  gg_point(
    ...
    subtitle = "**{.#0095a8ff Adelie}**, **{.#ffa600ff Chinstrap}**, *and* **{.#003f5cff Gentoo}** species",
    mode = light_mode_n()
  ) +
  theme(plot.title = marquee::element_marquee(margin = margin(t = -11))) + 
  theme(plot.subtitle = marquee::element_marquee(margin = margin(t = -5.5, b = 11)))
```
