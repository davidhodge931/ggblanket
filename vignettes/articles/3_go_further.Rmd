...
Use `ink_rescale` to rescale a diverging scale around a central point. 
...
mpg  |>  
  gg_point(
    ...
    y = hwy, 
    ink = cty,
    ink_palette = c(navy, teal, "white", orange, red),
    ink_rescale = scales::rescale(rescale_vctr),
    ink_breaks = scales::breaks_width(5),
    mode = dark_mode_r(),
  )
```
